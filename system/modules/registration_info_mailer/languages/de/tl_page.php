 ...
 * registration mails
 */
$GLOBALS['TL_LANG']['tl_page']['rim_active']				= array('Registrierungebenachichtigung aktivieren', 'Klicken Sie diese Schaltfläche an wenn Sie das Senden von Registrierungsinfos aktivieren wollen.');
$GLOBALS['TL_LANG']['tl_page']['rim_mail_from']				= array('Absenderadresse', 'E-Mail Adresse des Absenders (BSP: noreply@foobar.com)');
$GLOBALS['TL_LANG']['tl_page']['rim_do_syslog']				= array('Logging aktivieren', 'Durch Aktivieren dieser Option werden alle verschickten E-Mails im Systemlog vermerkt.');
$GLOBALS['TL_LANG']['tl_page']['rim_mail_from_name']		= array('Name des Absenders', 'Name des Absenders (BSP: Dont Answer Me)');
$GLOBALS['TL_LANG']['tl_page']['rim_subject']				= array('Betreff', 'Betreff des Info-Mails');
 ...
 * activation mails
 */
$GLOBALS['TL_LANG']['tl_page']['rim_act_active']			= array('Aktivierungsbenachichtigung aktivieren', 'Klicken Sie diese Schaltfläche an wenn Sie das Senden von Aktivierungsinformationen aktivieren wollen.');
$GLOBALS['TL_LANG']['tl_page']['rim_act_mail_from']			= array('Absenderadresse', 'E-Mail Adresse des Absenders (BSP: noreply@foobar.com)');
$GLOBALS['TL_LANG']['tl_page']['rim_act_do_syslog']			= array('Logging aktivieren', 'Durch Aktivieren dieser Option werden alle verschickten E-Mails im Systemlog vermerkt.');
$GLOBALS['TL_LANG']['tl_page']['rim_act_mail_from_name'] 	= array('Name des Absenders', 'Name des Absenders (BSP: Dont Answer Me)');
$GLOBALS['TL_LANG']['tl_page']['rim_act_subject']			= array('Betreff', 'Betreff des Info-Mails');
